...
\begin{tikzpicture}
	...
	\duck[scale=3, viking, torch, yshift=-0.6cm, xshift=1.4cm]

	\node[
	ellipse callout,
	callout absolute pointer={(4.8,3.3)},
	fill=blue!5,
	draw=black,
	thick,
	align=center,
	...
	{\large Questa versione è del \bfseries\today,\\
	\large\href{https://emipano.github.io/Islena/}{clicca qui} per controllare se ci sono aggiornamenti!};
\end{tikzpicture}
...
\textbf{Benefici}: Quando applichi un talento di metamagia a un incantesimo lanciato spontaneamente, il lancio impiega solo il tempo di lancio normale.

\subsection{Asceta Ombra [generale]}
...
\textbf{Benefici}: I livelli da monaco e da ninja si sommano al fine del calcolo degli utilizzi giornalieri dei poteri \textit{ki}. Per esempio, un monaco di 4° livello/ninja di 2° livello con questo talento può usare i suoi poteri ki un numero di volte al giorno pari a 3 (metà della somma tra i suoi livelli da monaco e da ninja) + il suo bonus di Saggezza (se ne ha uno).\\
I livelli da monaco e da ninja si sommano anche al fine di determinare il danno del colpo senz'armi, oltre alla capacità di classe colpo \textit{ki}. Per esempio, un monaco di 4° livello/ninja di 6° livello infligge 1d10 danni col suo colpo senz'armi e può superare la riduzione del danno come un'arma allineata legale e magica (come un monaco di 10° livello).\\
